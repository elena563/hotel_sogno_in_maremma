...
export default function RoomsRow({ rooms }: { rooms: Room[] }) {
  type OpenIndex = number | null;
  const [openIndex, setOpenIndex] = useState<OpenIndex>(null);
  const [pendingOpen, setPendingOpen] = useState<OpenIndex>(null);
